...
from cradle.environment.xiuxiu.skill_registry import register_skill, post_skill_wait
from cradle.environment.software.atomic_skills import base

config = Config()
logger = Logger()
io_env = IOEnvironment()

slight_scroll_distance = 300
...
def double_click_at_position(x, y, mouse_button):
    ...
    base.double_click_at_position(x, y, mouse_button)
