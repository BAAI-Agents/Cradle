...
def go_to_horse():
    ...
    """
    go_to_icon("horse", iterations=constants.DEFAULT_GO_TO_HORSE_ITERATIONS, debug=False)


# @register_skill("go_to_icon")
def go_to_icon(target: str = "horse", iterations=constants.DEFAULT_GO_TO_ICON_ITERATIONS, debug: bool = False):
    """
