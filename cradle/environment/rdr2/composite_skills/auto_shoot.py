...
def shoot_people():
    ...
    """
    keep_shooting_target(constants.DEFAULT_MAX_SHOOTING_ITERATIONS, detect_target=constants.SHOOT_PEOPLE_TARGET_NAME, debug=False)
...
def shoot_wolves():
    ...
    """
    keep_shooting_target(constants.DEFAULT_MAX_SHOOTING_ITERATIONS, detect_target=constants.SHOOT_WOLVES_TARGET_NAME, debug=False)
...
def keep_shooting_target(
    ...
    for step in range(1, 1 + iterations):
        ...
        if constants.SHOOT_PEOPLE_TARGET_NAME in detect_target.lower():
