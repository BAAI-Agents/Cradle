...
def navigate_path(iterations = constants.DEFAULT_NAVIGATION_ITERATIONS, debug = False):
    """
...
def cv_navigation(total_iterations, terminal_threshold=constants.NAVIGATION_TERMINAL_THRESHOLD, debug = False):
